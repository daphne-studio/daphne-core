---Example: ND_Core Script Running on QBCore Adapter
---This script demonstrates how an ND_Core script can work on a QBCore server using daphne-core proxy

-- This script uses ND_Core API but will work on QBCore adapter
RegisterNetEvent('example:giveMoney', function()
    local source = source
    
    -- ND_Core API call - will be proxied to QBCore adapter
